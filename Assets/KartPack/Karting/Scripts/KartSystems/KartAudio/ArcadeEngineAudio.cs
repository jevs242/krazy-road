    ...
    public class ArcadeEngineAudio : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (arcadeKart != null)
            {
                ...
                Drift.volume = arcadeKart.IsDrifting && arcadeKart.GroundPercent > 0.0f ? arcadeKart.Rigidbody.linearVelocity.magnitude / arcadeKart.GetMaxSpeed() : 0.0f;
            }

            IdleSound.volume    = Mathf.Lerp(1f, 1.0f, kartSpeed * 4);
